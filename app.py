...
model = keras.models.load_model('model.h5')  # back to .h5
...
with col2:
    ...
    balance          = st.slider('Balance',          min_value=0.0,                   value=50000.0)
    estimated_salary = st.slider('Estimated Salary', min_value=0.0,                   value=50000.0)
